...
import { B as Block, S as StatusTracker, e as BlockLabel, O as Code$2, g as Empty, i as IconButton$1, H as Copy$1, D as Download$1, h as IconButtonWrapper$1 } from './2-CI5fLukF.js';
...
const lang_map = {
  python: () => import('./index27-DAZmwlho.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-oLY_TJ4D.js'),
      import('./frontmatter-UG1lPyZj.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-DLQUzhx8.js').then((m) => m.json()),
  html: () => import('./index29-DRMdSRqa.js').then((m) => m.html()),
  css: () => import('./index30-BQ3aYd3P.js').then((m) => m.css()),
  javascript: () => import('./index31-C0HtCWEz.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-C0HtCWEz.js').then(
...
const Copy_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.value === void 0 && $$bindings.value && value !== void 0)
    $$bindings.value(value);
  return `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Copy$1 }, {}, {})}`;
});
const Copy = Copy_1;
...
const Download_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(DownloadLink, "DownloadLink").$$render(
    ...
    {
      default: () => {
        return `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Download$1 }, {}, {})}`;
      }
    }
  )}`;
});
...
//# sourceMappingURL=Index13-dRq_GVLJ.js.map
